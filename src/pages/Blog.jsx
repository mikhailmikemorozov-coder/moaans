...
const POSTS = [
  {
    ...
    excerpt: "Двухтоновый кастом — графитовые спицы, чёрный матовый хаб. Жидкая краска с маскировкой даёт идеально чёткую границу цветов. Пять ракурсов готового комплекта.",
    date: "2 июня 2026",
    readTime: "2 мин",
    image: "/custom2-11.webp",
    tag: "Наши работы",
    tagColor: "#bf00ff",
  },
  {
    slug: "kastomnyy-dizayn-diskov",
    title: "Кастомный дизайн дисков: чёрный + алюмохром",
    excerpt: "Четыре слоя работы на каждом диске — грунт, алюмохром жидкарь, маскировка + чёрный жидкарь, порошковый лак. Разбираем процесс и показываем результат.",
    date: "16 мая 2026",
    readTime: "3 мин",
    image: "/custom-after.webp",
    tag: "Наши работы",
    tagColor: "#bf00ff",
  },
  {
    slug: "pokraska-supportov",
    title: "Покраска суппортов: зачем, как и сколько стоит",
    excerpt: "Яркие суппорты сквозь спицы — один из самых заметных тюнингов. Разбираем почему нельзя обычную краску, как проходит процесс и что получается в итоге.",
    date: "16 мая 2026",
    readTime: "4 мин",
    image: "/support-red.webp",
    tag: "Покраска суппортов",
    tagColor: "#ff6b00",
  },
  {
    ...
    date: "14 мая 2026",
    readTime: "2 мин",
    image: "/work-nissan-compare.webp",
    tag: "Наши работы",
    tagColor: "#f0b429",
  },
  {
