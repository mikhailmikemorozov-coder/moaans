...
export default function AlmaznayaProchka() {
  return (
    <ServicePage
      ...
      video={{
        src: "/prochka-process-web.mp4",
        title: "Алмазный резец на станке с ЧПУ",
        desc: "Программа ведёт резец по точной траектории — снимает ровно 0,1–0,3 мм металла. Именно эти микробороздки создают характерный заводской блеск diamond cut, который невозможно получить полировкой.",
        stats: [
          { val: "20–40 мин", label: "на 1 диск" },
          { val: "0,1–0,3 мм", label: "снимает резец" },
