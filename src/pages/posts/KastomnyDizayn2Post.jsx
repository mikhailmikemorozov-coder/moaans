...
export default function KastomnyDizayn2Post() {
  return (
    <div style={{ fontFamily: "'Nunito', sans-serif", background: "#08090c", color: "#fff", minHeight: "100vh" }}>
      <Helmet>
        <title>Кастомный дизайн дисков: порошковая покраска + алмазная проточка — наша работа | BI Color</title>
        <meta name="description" content="Реальный результат: трёхслойная порошковая покраска разными цветами и алмазная проточка на станке. Графитовые спицы со шлифованными гранями, чёрный мат. Пять фото. BI Color, Москва." />
        <meta name="keywords" content="кастомный дизайн дисков, алмазная проточка покраска, порошковая покраска разными цветами, двухтоновые диски москва, кастом диски работа" />
        <link rel="canonical" href="https://bi-color.ru/blog/kastomnyy-dizayn-grafit-chernyy" />
        <meta property="og:title" content="Кастомный дизайн: покраска + алмазная проточка — BI Color" />
        <meta property="og:description" content="Трёхслойная порошковая покраска разными цветами и алмазная проточка на станке. Графитовые спицы со шлифованными гранями, чёрный мат. Пять ракурсов." />
        <meta property="og:image" content="https://bi-color.ru/custom2-11.webp" />
        <meta property="og:type" content="article" />
        <script type="application/ld+json">{JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Article",
          "headline": "Кастомный дизайн дисков: порошковая покраска + алмазная проточка",
      ...
      <section className="post-hero" style={{ padding: "130px 40px 40px", maxWidth: 780, margin: "0 auto" }}>
        ...
        <h1 style={{ fontFamily: "'Rajdhani'", fontWeight: 700, fontSize: "clamp(30px, 5vw, 52px)", lineHeight: 1.1, marginBottom: 24 }}>
          Кастомный дизайн: порошковая покраска + алмазная проточка
        </h1>

        <p style={{ fontSize: 17, color: "rgba(255,255,255,.5)", lineHeight: 1.8 }}>
          Три слоя порошковой краски разных цветов и работа на станке с алмазной проточкой — так получается уникальный двухтоновый дизайн на пятиспицевых дисках. Никакой маскировки — граница цветов создаётся алмазным резцом.
        </p>
      </section>
      ...
      <div style={{ maxWidth: 620, margin: "0 auto", padding: "48px 40px" }}>
        <p style={{ fontSize: 16, color: "rgba(255,255,255,.55)", lineHeight: 1.9, textAlign: "center", margin: 0 }}>
          Три слоя порошковой краски запекаются при 200°C — каждый цвет отдельно. Затем диск устанавливается на станок с ЧПУ: алмазный резец снимает верхний слой на спицах с точностью до микрона, открывая нужный цвет. Граница между цветами — чёткая, без ни одного размытого перехода.
        </p>
      </div>
      ...
      <article className="article post-body" style={{ maxWidth: 780, margin: "0 auto", padding: "0 40px 0" }}>
        <div style={{ background: "rgba(255,255,255,.03)", border: "1px solid rgba(255,255,255,.07)", borderRadius: 16, overflow: "hidden" }}>
          {[
            ...
            ["Технология", "3 слоя порошковой краски разных цветов → алмазная проточка на станке с ЧПУ → вскрытие лаком"],
            ["Слоёв покраски", "3"],
