    ...
    <div style={{ fontFamily: "'Nunito', sans-serif", background: "#08090c", color: "#fff", minHeight: "100vh" }}>
      ...
      <header className="post-header" style={{
        ...
        <div className="post-nav" style={{ display: "flex", gap: 28, alignItems: "center" }}>
          {[["Главная", "/"], ["Блог", "/blog"], ["Цены", "/tseny"], ["Ремонт дисков", "/remont-diskov-moskva"]].map(([label, href]) => (
        ...
        <div style={{ display: "flex", gap: 16, alignItems: "center" }}>
          ...
          <Link to="/remont-diskov-moskva" style={{ display: "inline-flex", alignItems: "center", padding: "10px 24px", background: "linear-gradient(135deg,#ff0080,#bf00ff)", color: "#fff", borderRadius: 50, fontFamily: "'Rajdhani'", fontSize: 14, fontWeight: 700, letterSpacing: 1.5, textTransform: "uppercase" }}>Записаться</Link>
        </div>
      </header>
      ...
      <article className="article post-body" style={{ maxWidth: 780, margin: "0 auto", padding: "0 40px 100px" }}>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
            <a href="tel:+74991365500" style={{ display: "inline-flex", alignItems: "center", padding: "12px 28px", background: "linear-gradient(135deg,#ff0080,#bf00ff)", color: "#fff", borderRadius: 50, fontFamily: "'Rajdhani'", fontSize: 15, fontWeight: 700, letterSpacing: 1 }}>
              +7 (499) 136-55-00
            </a>
