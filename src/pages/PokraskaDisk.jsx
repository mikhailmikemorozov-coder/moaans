  ...
  return (
    <ServicePage
      meta={{
        ...
        description: "Порошковая покраска литых дисков в Москве: трёхслойное нанесение, гарантия 4 года, срок 1–2 дня. Любой цвет RAL. Внуково, Центральная ул. 18с2.",
        keywords: "покраска дисков москва, реставрация дисков москва, порошковая покраска литых дисков, покраска дисков цена, порошковая покраска дисков внуково",
      ...
      gallery={[
        { src: "/pokraska-6.webp", alt: "Порошковая покраска дисков в золотом цвете RAL", caption: "Золотой металлик, матовый финиш" },
        { src: "/pokraska-8.webp", alt: "Порошковая покраска диска в кэнди-зелёном цвете", caption: "Кэнди-зелёный, глянцевый финиш" },
        { src: "/pokraska-10.webp", alt: "Порошковая покраска диска в серебристом цвете", caption: "Серебристый, глянцевый финиш" },
        { src: "/pokraska-7.webp", alt: "Порошковая покраска комплекта дисков в ярко-зелёном цвете", caption: "Ярко-зелёный RAL, глянец — комплект 4 диска" },
        { src: "/pokraska-9.webp", alt: "Порошковая покраска дисков в тёмно-серый антрацит", caption: "Антрацит, глянцевый финиш — комплект 4 диска" },
        { src: "/pokraska-11.webp", alt: "Порошковая покраска литых дисков — работа BI Color", caption: "Покраска дисков — результат работы" },
      ]}
      faqItems={[
